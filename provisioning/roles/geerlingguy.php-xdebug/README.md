...
Where Xdebug setup files will be downloaded and built.
    ...
    php_xdebug_version: 2.7.0beta1

The version of Xdebug to be installed (see [Updates](https://xdebug.org/updates.php) for a current listing). **If using PHP 5.6**: Set this to `2.5.0` or earlier, as starting with XDebug 2.7.0beta1, PHP 5.x support has been dropped.
